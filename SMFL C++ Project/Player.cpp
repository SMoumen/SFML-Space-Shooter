...
void Player::updatePlayer(bool continuous)
{
	...
	if (keyDown(Key::Up))
	{
		...
		moving = true;
	} // setDirection(Animation::Direction::up);    moving = true; }
	else if (keyDown(Key::Left))
	{
		playerMovement.x -= speed;
		moving = true;
	} //setDirection(Animation::Direction::left);  moving = true; }
	else if (keyDown(Key::Down))
	{
		playerMovement.y += speed;
		moving = true;
	} //setDirection(Animation::Direction::down);  moving = true; }
	else if (keyDown(Key::Right))
	{
		playerMovement.x += speed;
		moving = true;
	} //setDirection(Animation::Direction::right); moving = true; }
	else { moving = false; }
